    ...
    ##    MODEL_NAME='keras_model.h5'
        ...
        for num, data in enumerate(verify_data):
            ...
            if np.argmax(model_out) == 0:
                ...
                str_label = "Severe"
                print("The predicted image of the Moderate is with a accuracy of {} %".format(model_out[4]*100))
                accuracy="The predicted image of the Moderate is with a accuracy of {}%".format(model_out[4]*100)
